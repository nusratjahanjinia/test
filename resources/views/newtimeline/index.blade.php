			...
			<div class="portlet light">
				<div class="portlet-body">
					<div class="timeline">
                        ...
                        @foreach($newtimeline as $tl)
						<!-- TIMELINE ITEM -->
						<div class="timeline-item">
							<div class="timeline-badge">
								<img class="timeline-badge-userpic" src="../../assets/admin/pages/media/users/baby.jpg">
							</div>
							<div class="timeline-body">
								...
								<div class="timeline-body-head">
									<div class="timeline-body-head-caption">
										...
										<a href="#" class="timeline-body-title font-blue-madison">{{$tl->title}}</a>
										<span class="timeline-body-time font-grey-cascade">{{$tl->published_at}}</span>
									...
									<div class="timeline-body-head-actions">
                                        <div class="btn-group">
                                            <button class="btn btn-circle green-haze btn-sm dropdown-toggle" type="button" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                What To Do <i class="fa fa-angle-down"></i>
                                            </button>
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="newtimeline/create">Create </a>
                                                </li>
                                                <li>
                                                    <a href="newtimeline/show">show</a>
                                                </li>
                                                <li>
                                                    <a href="#">status</a>
                                                </li>
